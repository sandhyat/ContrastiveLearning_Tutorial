...
if __name__ == '__main__':
    ...
    elif args.loader == 'epic':
        task_type = 'classification'
        train_data, train_labels, test_data, test_labels = datautils.load_epic(args.dataset, args.outcome)
    ...
    if args.eval:
        if task_type == 'classification':
            ...
            out, eval_res = eval_classification(model, train_data, train_labels, test_data, test_labels,args.preops,args.outcome)
