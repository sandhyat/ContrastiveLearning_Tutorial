...
class TS2Vec:
    ...
    def fit(self, train_data, temperature=1, n_epochs=None, n_iters=None, verbose=False):
        ...
        while True:
            ...
            for batch in train_loader:
                ...
                # possibly adding the embedding layer

                # this is the augmentation part (mainly cropping, masking is done inside the encoder training part)
                ts_l = x.size(1)
